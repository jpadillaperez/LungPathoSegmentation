...
from datasets.base_longitudinal import BaseLongitudinal
from datasets.dataset_2d_longitudinal import DynamicDataset2DLongitudinal
...
class Segmentation2D(BaseLongitudinal):
    ...
    def resize_images(self):
            return transforms.Resize((300, 300), interpolation=Image.LINEAR)
