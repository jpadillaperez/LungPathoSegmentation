...
class Segmentation3D(l.LightningModule):
    def __init__(self, hparams, model):
        ...
        self.label_list = ['background', 'healthy_lung', 'GGO', 'consolidation', 'pleural_effusion']
    ...
    def configure_optimizers(self):
        ...
        if self.hparams["lr_scheduler"] == 'StepLR':
            lr_scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=self.hparams["lr_scheduler_step_size"], gamma=self.hparams["lr_scheduler_gamma"])
            ...
            return {'optimizer': optimizer, 'lr_scheduler': lr_scheduler, 'monitor': 'Train Dice Loss'}
        else:
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        self.log('Train DiceLoss pleural effusion', diceloss_pleural_effusion, on_step=False, on_epoch=True)
...
#-----------------VALIDATION-----------------#
    ...
    def on_validation_epoch_end(self):
        ...
        self.log('Val Dice Pleural effusion', volume_means.get('Diceval_pleural_effusion', default_value))
...
#-----------------TEST-----------------#
    ...
    def on_test_epoch_end(self):
        ...
        self.log('Test Dice Pleural effusion', volume_means.get('Dicetest_pleural_effusion', default_value))
        ...
        self.log('Test Dice Pleural effusion std', volume_stds.get('Dicetest_pleural_effusion', default_value))
